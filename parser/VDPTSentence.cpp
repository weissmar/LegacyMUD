...
VDPTSentence::VDPTSentence(VerbType type, const LexicalData &playerLex, const LexicalData &areaLex) {

}

// Gets a vector of ParseResult objects based on the parsed input string.
std::vector<ParseResult> VDPTSentence::getResults() {
...
ParseStatus VDPTSentence::getResultStatus() {
